...
<body class="font-display">
    ...
    <section id="about" class="overflow-hidden lg:py-20 sm:py-8 py-5 bg-[#F0F2F3]">
            <div class="container px-3 md:px-5 xl:px-0">
                ...
                <h2 class="text-gray-black xl:text-[32px] xl:leading-[110%] text-xl md:text-2xl font-semibold font-display capitalize">User Signup Data</h2>
                <br>
                <br>
                <?php include 'display_signup.php'; ?>
                </div>
            </div>
    </section>
    <br>
    <section id="about" class="overflow-hidden lg:py-20 sm:py-8 py-5 bg-[#F0F2F3]">
            <div class="container px-3 md:px-5 xl:px-0">
                <div class="flex flex-wrap justify-between items-center mb-10">
                <h2 class="text-gray-black xl:text-[32px] xl:leading-[110%] text-xl md:text-2xl font-semibold font-display capitalize">Products List Data</h2>
                <br>
                <br>
            ...
            <div class="container px-3 md:px-5 xl:px-0">
                <div class=" flex flex-wrap gap-y-6 justify-between">
                    ...
                    <div class="footer-widget w-[424px]">
                        ...
                        <br>
                        <form action="" class="flex flex-wrap xl:flex-nowrap gap-3">
                            <input type="text" name="" id="" class="bg-[#FFFFFF] block max-w-[285px] w-full px-5 py-[15px] rounded-lg focus:outline-none focus:ring-2 focus:ring-accents transition duration-300 ease-in-out border border-[#E1E3E6]" placeholder="Message">
                            <button type="submit" class="btn-primary">Send</button>
                        </form>
