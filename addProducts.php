...
<head>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Execute statement
        if ($stmt->execute()) {
            echo "<script>alert('Updated successfully.'); window.location.href = 'accountSettingPage.php';</script>";
            exit();
        } else {
...
<body class="font-display">
                ...
                <div class="py-3.5 flex justify-between items-center">
                    <div class="flex gap-8 items-center">
                        ...
                        <ul class="lg:flex gap-8 items-center hidden main-menu">
                            ...
                            <li>
                                <a href="products.html">Latests</a>
                            </li>
                    ...
                    <div>
                        <p class="text-grayscales-900 inline-flex gap-2 items-center text-sm font-display">
                            <span>Welcome, <?php echo $firstName; ?> !!</span></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container px-3 md:px-5 xl:px-0">
        <!-- Methana idan ptan gnn ona.-->

        <div class="container py-20">
            <div class="sign_in">
                <h2 class="text-center text-gray-black xl:text-[32px] text-[20px] font-semibold font-display">Add Your
                    Product</h2>
                <div class="form">

                    <!-- <form action="account-setting.php" method="post" class=""> -->

                    <form action="insertProducts.php" method="post" enctype="multipart/form-data">
                        <div class="mb-4">
                            <input type="text" id="sellerName" name="selleName" placeholder="Seller Name"
                        ...
                        <div class="mb-4">
                            <select id="category" name="category" placeholder="Category"
                                ...
                                onmouseover="this.style.backgroundColor='##029FAE';"
                                onmouseout="this.style.backgroundColor='transparent';"
                                onchange="this.style.backgroundColor='#029FAE';"
                                onfocus="this.style.backgroundColor='transparent';"
                                onblur="this.style.backgroundColor='transparent';"
                                onmousedown="this.style.backgroundColor='transparent';"
                                onmouseup="this.style.backgroundColor='transparent';">
                                <option value="" selected disabled>Select Category</option>
                                <option value="Vegetables">Vegetables</option>
                                <option value="Fruits">Fruits</option>
                                <option value="Meat">Meat</option>
                                <option value="Eggs or Diary Product">Eggs or Diary Product</option>
                        ...
                        <div class="mb-4">
                            <select id="sellCategory" name="sellCategory" placeholder="Selling Method"
                                class="input-box focus:outline-none focus:ring-2 focus:ring-accents font-display transition duration-300 ease-in-out"
                                style="background-color: transparent;"
                                onmouseover="this.style.backgroundColor='##029FAE';"
                                onmouseout="this.style.backgroundColor='transparent';"
                        ...
                        <!-- <div class="mb-4">
                                <input type="number" id="sPrice" name="sPrice" placeholder="Stock Price"
                                    class="input-box focus:outline-none focus:ring-2 focus:ring-accents font-display transition duration-300 ease-in-out">
                            </div> -->
                        ...
                        <div class="mb-4 flex items-center">
                            <input type="file" id="photo" name="photo" accept=".jpeg, .jpg, .png"
                                style="display: none;">
                            <label for="photo" id="select-button"
                                class="flex gap-3 items-center transition-all duration-300 hover:bg-[#272343] bg-accents text-white text-base font-semibold py-[17px] px-6 rounded-lg font-display cursor-pointer">
                                <span>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke-linejoin="round" />
                                        <path d="M12 19.5V9.5M12 9.5L8.5 13M12 9.5L15.5 13" stroke="white"
                        ...
                        <button class="form_btn w-full">
                            ...
                            <span>
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M16 7.5L20.5 12M20.5 12L16 16.5M20.5 12H4.5" stroke="white"
                                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </span>
                        </button>
                        <a href="index.php" class="form_btn w-full flex items-center justify-center">
                            Back to Home
                        </a>
                ...
                <div class="container px-3 md:px-5 xl:px-0">
                    <div class=" flex flex-wrap gap-y-6 justify-between">
                        ...
                        <div class="footer-widget w-[424px]">
                            ...
                            <p class="py-3 text-gray-black opacity-60">Reach out to us with your inquiries and feedback,
                                <br> We're here to grow together..</p>
                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            // Get the element where you want to display the user's first name
            var welcomeMessage = document.getElementById("welcomeMessage");

            // Get the user's first name from PHP session variables
            var firstName = "<?php echo isset($_SESSION['firstName']) ? $_SESSION['firstName'] : 'User'; ?>";

            // Update the content of the element with the user's first name
