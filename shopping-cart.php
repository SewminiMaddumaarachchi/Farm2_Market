    ...
    <div class="breadcrumb">
        <div class="container px-3 md:px-5 xl:px-0">
            <div class="flex items-center gap-1 py-[1.5px]">
                ...
                <span class="text-[14px] font-medium leading-[110%] font-display text-gray-black inline-block">Shopping
                    Cart</span>
            </div>

            <h2 class="pt-[13.5px] text-2xl font-semibold text-gray-black font-display">Shopping Cart</h2>
        </div>
    </div>
    <!-- Breadcrumb End -->
    ...
    <!-- <section>
        <div class="container px-3 md:px-5 xl:px-0">
            ...
            <div class="shopping-cart-wrapper pt-10 pb-20 flex lg:flex-nowrap flex-wrap items-start gap-6">
                ...
                $selectSql = "SELECT productName, quantity, price, photoUrl FROM cart";
                                    ...
                                    <table class="w-[824px] leading-normal">
                                        ...
                                        <tbody>
                                                    ...
                                                    <tr class="cart-item">
                                                        <td class="py-6 text-sm">
                                                            <div class="flex gap-2 items-center">
                                                                ...
                                                                <div class="w-[70px] h-[70px]">
                                                                    <img class="w-full h-full rounded-lg" src="<?php echo $row['photoUrl']; ?>" alt="Product Image" />
                                                                </div>
                                                                <div class="ml-1">
                                                                    <p class="mb-0 text-[#272343] text-sm"><?php echo $row['productName']; ?></p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="py-6 text-sm">
                                                            <div class="border inline-flex justify-around items-center h-[52px] w-[140px] border-[#D6D9DD] rounded-lg">
                                                                <!-- You can display quantity input field here -->
                                                                <div class="border inline-flex justify-around items-center h-[52px] w-[140px] border-[#D6D9DD] rounded-lg">
                                                                    <span class="w-5 h-5 inline-flex justify-center items-center text-[#9A9CAA] pl-[14px] select-none minus" id="minus">-</span>
                                                                    <input type="text" class="text-[#272343] text-base plus_mines_input" value="01" />
                                                                    <span class="w-5 h-5 inline-flex justify-center items-center text-[#9A9CAA] pr-[14px] select-none plus" id="plus">+</span>
                                            ...
                                            <?php
                                                ...
                                                // Handle case where no items are in the cart
                            ...
                            <div class="cart-total p-8 lg:w-1/3 w-full">
                                <div class="subtotal-info">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <p
                                            class="text-gray-black text-[22px] leading-[120%] font-display font-semibold">
                                            $1026.23</p>
                                    </div>
                                    <button
