...
<body class="font-display">
    ...
    <section
                ...
                <div class="swiper-slide">
                    <div class="container px-3 md:px-5 flex flex-col md:flex-row items-center">
                        <div class="md:w-1/2 w-full">
                            <p class="text-gray-black text-sm tracking-[0.12em] mb-2">Welcome to the Agricultural
                                Revolution</p>
                            <h1
                                class="xl:text-[68px] text-xl md:text-3xl xl:leading-[110%] text-gray-black font-semibold mb-6">
                                Freshness Unleashed.. <br> Bid, Buy, Enjoy!</h1>
                            <div>
                ...
                <div class="swiper-slide">
                    <div class="container px-3 md:px-5 flex flex-col md:flex-row items-center">
                        <div class="md:w-1/2 w-full">
                            ...
                            <h1
                                class="xl:text-[68px] text-xl md:text-3xl xl:leading-[110%] text-gray-black font-semibold mb-6">
                                Bid High, Eat Fresh! <br> Your Farm2Market Experience..</h1>
                            <div>
                ...
                <div class="swiper-slide">
                    <div class="container px-3 md:px-5 flex flex-col md:flex-row items-center">
                        <div class="md:w-1/2 w-full">
                            ...
                            <h1
                                class="xl:text-[68px] text-xl md:text-3xl xl:leading-[110%] text-gray-black font-semibold mb-6">
                                Nature's Best, Your Best! <br> Farm2Market's Bounty Awaits..</h1>
                            <div>
                                <a href="products.html" class="btn-primary">
                                    <span>Shop Now</span>
                                    <span><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
        ...
        <img src="./public/assets/images/svg/banner-shapes.svg" alt=""
            ...
            <div
                ...
                <div class="grid grid-cols-1 xl:grid-cols-4 sm:grid-cols-2 gap-6">
                    ...
                    <div class="feature-card flex gap-4 items-center w-full max-w-[280px]">
                        ...
                        <div>
                            <h3 class="text-lg leading-[110%] text-gray-black mb-1.5 font-medium">Customer Service 24/7
                            </h3>
                        ...
                        <div
                            ...
                            <div class="shadow-[inset_2px_0px_0px_#029FAE] pl-6">
                                <p
                                    ...
                                    “"As a farmer, Farm2Market has opened up new opportunities for me to reach customers
                                    and expand my business.“</p>
                            </div>
                            <div class="flex justify-between items-end">
                                <div class="flex items-center flex-wrap gap-3">
                                    <div class="lg:w-[60px] lg:h-[60px] sm:w-12 sm:h-12 w-8 h-8">
                                        <img src="./public/assets/images/all-img/supun-perera-gqA9S.jpeg" alt=""
                    ...
                    <div class="swiper-slide">
                        ...
                        <div
                            ...
                            <div class="shadow-[inset_2px_0px_0px_#029FAE] pl-6">
                                <p
                                    class="text-[#636270] font-display font-normal lg:text-[20px] lg:leading-[150%] sm:text-base text-sm capitalize">
                                    “This is a good move to Sri Lankan Agriculture.A positive change for the business
                                    and people.Keep up the good work!!“</p>
                            </div>
                            <div class="flex justify-between items-end">
                                <div class="flex items-center flex-wrap gap-3">
                                    <div class="lg:w-[60px] lg:h-[60px] sm:w-12 sm:h-12 w-8 h-8">
                                        <img src="./public/assets/images/all-img/gathika.png" alt=""
                                            class="w-full h-full rounded-full">
                                    </div>
                                    <div>
                                        <h4
                                            class="xl:text-[20px] xl:leading-[140%] text-sm md:text-base text-gray-black capitalize font-medium font-display">
                                            Gathika Colombage</h4>
