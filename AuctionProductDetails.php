                    ...
                    <div class="product-details-wrap pt-10">
                        <div class="left-side xl:w-7/12 w-full">
                            ...
                            <div class="single-product-desc">
                                ...
                                <p class="text-[#636270] text-base mb-3">
                        ...
                        <p class="flex gap-1.5 items-center">
                            ...
                            <div class="mb-6">
                                <ul class="p-0 m-0">
                                    ...
                                    <li>
                                        <p class="text-[15px] inline-flex gap-2 items-center">
                                            <span class="text-[#9A9CAA]">Category:</span>
                                            <?php echo $row["category"]; ?><span class="text-[#636270] font-medium"></span>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="text-[15px] inline-flex gap-2 items-center">
                                            <span class="text-[#9A9CAA]">Minimum Price for 1kg:</span><span
                                                class="text-[#636270] font-medium">Rs.
                                                <?php echo $row["Price"]; ?>
                                            </span>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="text-[15px] inline-flex gap-2 items-center">
                                            <span class="text-[#9A9CAA]">Quantity:</span>
                                            <?php echo $row["quantity"]; ?><span class="text-[#636270] font-medium"></span>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="text-[15px] inline-flex gap-2 items-center">
                                            <span class="text-[#9A9CAA]">Added
                                                Time:</span>
                                            <?php echo $row["ProductTime"]; ?><span class="text-[#636270] font-medium"></span>
                                        </p>
                                    </li>
                                    <li>
